...
prompt = [
    ...
    - If the question is relevant and can be answered using the database, generate a SQL query to retrieve the necessary information.
    ...
    * Provide Examples:
    ...
    Question: dsf 
    Answer:
    Context:  It seems that you entered random letters.
